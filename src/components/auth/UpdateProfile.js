...
export default function UpdateProfile() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-200">
      ...
      <div className="bg-gray-100 p-4 flex flex-col mt-4 mx-auto rounded-lg shadow-lg w-1/3 space-y-8">
        <div className="flex flex-col items-center">
          ...
          <div className="w-full px-14 space-y-2">
            ...
            <div className="flex justify-between">
              <p>Currency</p>
              <div className="border-2 border-green-200 rounded-lg space-x-2">
                <button
                  className={`${
        ...
        <div className="flex flex-col items-center">
          ...
          >
            ...
            <button
              disabled={loading}
              type="submit"
              className="p-2 border-2 rounded-lg bg-green-100 hover:bg-green-200"
            >
